                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form action="aksi/periode.php" method="post">
                        ...
                        <input type="text" name="periode" value="<?= $kolom['periode']; ?>" class="form-control" require>
                        <br>
                        <label for="periode">Tanggal awal Periode</label>
                        <input type="date" name="tanggal_awal" value="<?= $kolom['tanggal_awal']; ?>" class="form-control" require>
                        <br>
                        <label for="periode">Tanggal Akhir Periode</label>
                        <input type="date" name="tanggal_akhir" value="<?= $kolom['tanggal_akhir']; ?>" class="form-control" require>
                        <br>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="aksi/periode.php" method="post">
          ...
          <label for="periode">periode</label>
          <input type="text" name="periode" class="form-control" require>
          <br>
          <label for="periode">Tanggal awal Periode</label>
        ...
        <table class="table table-hover">
          ...
          ?>
            <tr>
              ...
              <td>
                <a onclick="return confirm('Yakin akan mengembalikan data ini?')" href="aksi/periode.php?aksi=restore&id_periode=<?= $kolom['id_periode']; ?>"> <i class="fas fa-trash-restore"></i></a>
                &nbsp;
                <a onclick="return confirm('Yakin akan menghapus data ini?')" href="aksi/periode.php?aksi=hapus-permanen&id_periode=<?= $kolom['id_periode']; ?>"> <i class="fas fa-eraser"></i></a>
              </td>
            </tr>
          <?php
          } //Akhir While
