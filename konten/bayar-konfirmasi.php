            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="aksi/bayar.php"method="post" enctype="multipart/form-data">
                       ...
                       <label for="keterangan">Keterangan Pembambayaran</label>
                       <textarea name="keterangan" class="form-control" rows="3" placeholder="Isi dengan keterangan pembayaran seperti nama bank,nama pengrim,dll" readonly><?= $bayar['keterangan']; ?></textarea>

                        <label for="tanggal_bayar">Tanggal Pembayar</label>
                        ...
                        <img src="file/buktibayar/<?= $bayar['bukti']; ?>" width="100%" alt="">
