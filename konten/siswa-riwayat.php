                ...
                <div class="card-body">
                    ...
                    <table id="example1" class="table table-hover table-sm">
                        ...
                        while ($kolom = mysqli_fetch_array($query)) {
                            ...
                            if ($kolom['total_berbayar'] == $kolom['jumlah_biaya']) {
                                //Lunas
                                $warna = "bg-success";
                            } else if ($kolom['total_berbayar'] > 0 && $kolom['total_berbayar'] < $kolom['jumlah_biaya']) {
                                //Bayar Sebagian
                                $warna = "bg-warning";
                            } else {
                        ...
                        ?>
                            <tr class="<?= $warna ?>">
                                ...
                                <td><?= number_format($kolom['total_berbayar']); ?></td>
                                <td>
                                                                        <!-- Tombol informasi     -->
                                                                        <a title="Informasi Riwayat tagihan" href="index.php?p=siswa-info&id_tagihan=<?= $kolom['id_tagihan']; ?>"><i class="fas fa-search"></i></a>
                                </td>
                            </tr>
                    ...
                    <table id="example1" class="table table-hover table-sm">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <?php
                                    if ($kolom['status_vertifikasi'] == 'Belum Vertifikasi') {
                                    ...
                                    ?>
                                    <span class="<?= $class; ?>">
                                        <?= $kolom['status_vertifikasi']; ?>
                                    </span>
                                </td>
                                <td> <!-- Tombol informasi     -->
                                                                        <a title="Informasi Riwayat tagihan" href="index.php?p=bayar-alokasi-siswa&id_bayar=<?= $kolom['id_bayar']; ?>"><i class="fas fa-search"></i></a></td>
