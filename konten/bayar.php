                    ...
                    <table id="example1" class="table table-hover table-sm">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <!-- Info Alokasi-->
                                    <a href="index.php?p=bayar-alokasi&id_bayar=<?= $kolom['id_bayar']; ?>"><i class="fas fa-search"></i></a>&nbsp;
                                    <!-- Tombol Konfirmasi -->
                                    <?php if ($kolom['status_vertifikasi'] == 'Belum Vertifikasi') { ?>

                                        <a onclick="return confirm('Yakin akan Mengkonfirmasi pembayaran ini?')" href="index.php?p=bayar-konfirmasi&id_bayar=<?= $kolom['id_bayar']; ?>" title="Informasi Alokasi Pembayaran"><i class="fas fa-check"></i></a>
