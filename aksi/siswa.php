...
if($_POST){
    if($_POST['aksi']=='tambah'){
        ...
        $sql="INSERT INTO siswa (id_siswa,nis,nama,tingkat,kelas,id_jurusan,alamat,no_telp,email,dibuat_pada,diubah_pada,dihapus_pada) VALUES(DEFAULT,'$nis','$nama',$tingkat,'$kelas',$id_jurusan,'$alamat','$no_telp','$email',DEFAULT,DEFAULT,DEFAULT)";
// echo $sql;
...
notifikasi($koneksi);
        ...
        $sql="UPDATE siswa SET nis='$nis', nama='$nama',tingkat=$tingkat, kelas='$kelas', id_jurusan=$id_jurusan, alamat='$alamat', no_telp='$no_telp', email='$email' WHERE id_siswa=$id_siswa";
