    ...
    if($_POST['aksi']=='tambah-berdasarkan-kelas'){
        ...
        if($jumlah_siswa>=1 && $jumlah_biaya>=1){
            ...
            while($biaya=mysqli_fetch_array($query_biaya)){
                ...
                $sql="INSERT INTO tagihan(id_tagihan,id_biaya,id_siswa,kelas,keterangan,potongan,total_berbayar,dibuat_pada,diubah_pada,dihapus_pada)VALUE(DEFAULT,$id_biaya,$id_siswa,'$kelas','',0,0,DEFAULT,DEFAULT,DEFAULT)";
                // echo$sql."<br>";
